...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Home
      <small>Diagnosa Kerusakan Komputer</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="container pt-5 pb-md-4">
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-6 pt-md-0 pt-4">
                            <h3 class="mb-sm-4 mb-3 titlef" style="color: #000;">Kami adalah <span class="d-block-res">C<span class="type-js"><span
                                            class="text-js">.E.S.</span></span></span></h3>
                            <p>Sebuah website sistem pakar yang membantu anda mendiagnosa kerusakan komputer.</p>
                        </div>
                        <div class="col-md-6 banner-right mt-lg-4 mt-0 text-right offset-lg-1">
                            <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/bg.jpg" alt=" ">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="about-single p-3 d-flex justify-content-between">
                            ...
                            <div class="about-content">
                                ...
                                <p>Pengembang website sistem pakar diagnosa kerusakan komputer dengan metode forward chaining dan berbasis framework CI3.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="about-single p-3 d-flex justify-content-between">
                            ...
                            <div class="about-content">
                                ...
                                <p>Kami bekerja sama dengan pakar, yaitu seorang tukang servis komputer yang ahli mengenai kerusakan komputer sebagai sumber data kami.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="about-single p-3 d-flex justify-content-between">
                            ...
                            <div class="about-content">
                                ...
                                <p>Memberikan layanan diagnosa kerusakan komputer untuk memudahkan pengguna dalam mendiagnosis komputer yang mengalami masalah.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="w3l-bottom-grids-6 py-5" id="services">
            <div class="container py-md-5 py-4">
                <div class="titlef-main text-center mx-auto mb-5" style="max-width:600px;">
                    ...
                    <h3 class="titlef-style">Layanan Diagnosa Modern Yang Mudah Dan Cepat</h3>
                </div>
                <div class="row pt-md-4 justify-content-center">
                    <div class="col-lg-4 col-md-6 grids-feature">
                        <div class="area-box">
                            <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/pakar1.jpg" alt=" ">
                    ...
                    <div class="col-lg-4 col-md-6 grids-feature mt-md-0 mt-sm-5 mt-4">
                        <div class="area-box">
                            <img class="img-fluid" src="<?php echo base_url(); ?>assets/img/print.jpg" alt=" ">
                            <h4><a href="#feature" class="titlef-head">Cetak Hasil</a></h4>
                            <p>Anda dapat mencetak hasil diagnosa yang muncul untuk memudahkan anda dalam mengetahui kerusakan komputer.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 grids-feature mt-lg-0 mt-sm-5 mt-4">
                        <div class="area-box">
                            ...
                            <p>Terdapat berbagai tips perawatan perangkat komputer yang bisa anda lihat pada website ini.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row footer-top-29">
                        <div class="col-lg-4 col-md-6 col-sm-7 footer-list-29 footer-1 pr-lg-5">
                            <div class="footer-logo mb-3">
                                <a class="footer-brand-logo" href="<?php echo base_url(); ?>landing"><img src="<?php echo base_url(); ?>assets/img/ces.png" alt="logo"></a>
                            </div>
                            <p>Website sistem pakar untuk membantu mendiagnosis kerusakan komputer.</p>
