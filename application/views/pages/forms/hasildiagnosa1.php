    ...
    <div class="jawaban">
        <div class="row">
          <div class="jawab">
            ...
            <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="progress-description">
                    Komputer sepertinya <mark>tidak mengalami</mark> <b><?php
                    foreach ($penyakit as $key) {
                      echo $key->nama_penyakit;
                    }
                    ?></b>
            ...
            <h4>Anda bisa mencoba kembali dengan kerusakan komputer yang lain <a href="<?php echo base_url(); ?>konsultasi">konsultasi</a>.</h4>
            <br>
            <?php
            }?>
