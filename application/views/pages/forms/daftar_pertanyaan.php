  ...
  <section class="content">
        ...
        <div class="right">
          ...
          <div class="carousel-inner">
            <div class="item active">
              <img class="img-rounded" src="<?php echo base_url(); ?>assets/img/expert_system1.jpg" alt="Expert System" style="width:100%;">
            ...
            <div class="item">
              <img class="img-rounded" src="<?php echo base_url(); ?>assets/img/bg.jpg" alt="Sheep" style="width:100%;">
              <div class="carousel-caption">
                <h3>Komputer</h3>
              </div>
            </div>
            ...
            <div class="item">
              <img class="img-rounded" src="<?php echo base_url(); ?>assets/img/pakar1.jpg" alt="Sheep Expert" style="width:100%;">
              <div class="carousel-caption">
                <h3>Ahli Komputer</h3>
              </div>
            </div>
    ...
    <div class="media">
      <div class="media-left">
        <img src="<?php echo base_url(); ?>assets/img/newlogo.jpg" alt="doctor" class="media-object" style="width:60px">
      </div>
      <div class="media-body">
        <h3 class="media-heading">Computer Expert System</h3>
        <p>Sistem Pakar Diagnosa Kerusakan menggunakan Metode Forward Chaining berbasis WEB merupakan suatu sistem yang mendiagnosa kerusakan komputer melalui indikasi kerusakan lalu muncul gejala yang dialami oleh Komputer.
          Dengan menggunakan sistem ini, Anda dapat mengetahui kerusakan pada komputer.</p>
      </div>
    <br>
    </div>
            ...
            <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="progress-description">
                    Untuk mendiagnosis kerusakan komputer
                  </span>
