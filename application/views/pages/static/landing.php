    ...
    <header id="site-header" class="fixed-top">
        <div class="container-fluid">
            <nav class="navbar navbar-expand-lg stroke">
                <h1>
                    <a class="navbar-brand d-flex align-items-center" href="<?php echo base_url(); ?>landing">C. E. S.</a>
                </h1>
            ...
            <div class="container pt-5 pb-md-4">
                <div class="row align-items-center">
                    <div class="col-lg-5 col-md-6 pt-md-0 pt-4">
                        <h3 class="mb-sm-4 mb-3 title">Kami adalah <span class="d-block-res">C<span class="type-js"><span
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="about-single p-3 d-flex justify-content-between">
                        ...
                        <div class="about-content">
                            ...
                            <p>Kami bekerja sama dengan pakar, yaitu seorang ahli komputer yang ahli mengenai kerusakan komputer sebagai sumber data kami.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="about-single p-3 d-flex justify-content-between">
                        ...
                        <div class="about-content">
                            ...
                            <p>Memberikan layanan diagnosa kerusakan komputer untuk memudahkan pengguna dalam mendiagnosis kerusakan komputer.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row pt-md-4 justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 grids-feature mt-md-0 mt-sm-5 mt-4">
                    <div class="area-box">
                        ...
                        <p>Anda dapat mencetak hasil diagnosa yang muncul untuk memudahkan anda dalam merawat komputer nantinya.</p>
                    </div>
                </div>
        ...
        <div class="w3l-copyright">
            <div class="container">
                <div class="row bottom-copies align-items-center">
                    <p class="col-lg-8 copy-footer-29">@ 2022 . All rights reserved.</p>
