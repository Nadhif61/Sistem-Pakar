...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url(); ?>home" class="logo">
      ...
      <span class="logo-mini"><img class="img-rounded" src="<?php echo base_url(); ?>assets/img/newlogo.jpg" alt="icon" width="50px" height="50px"></style>></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="<?php echo base_url(); ?>assets/img/ces.png" alt="logo"></span>
    </a>
